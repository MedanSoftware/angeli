...
class Encryption_api
{
	...
	{
		$this->encryptionKey = config_item('encryption_key');
	}
	...
	{
		$key = (!empty($key))?$key:$this->encryptionKey;
...
/* End of file Encryption_api.php */
/* Location: ./application/libraries/Encryption_api.php */